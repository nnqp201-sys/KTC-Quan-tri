...
| Agent của plugin | **6**: `ktc-tu-hoc` · `ktc-tu-cai-tien` · `ktc-kiem-ho-so-don-vi` · `ktc-tra-cuu-can-cu` · `ktc-kiem-san-pham` · `ktc-hieu-luc-vien-dan` — chỉ đọc, chỉ ghi báo cáo; không lặp reviewer 897. Quét hiệu lực: `29-Cong-Cu/tra_hieu_luc.py` (THAY_THE · KHO_GHI_HET_HIEU_LUC · CO_TRONG_KHO · KHONG_CO_TRONG_KHO). Nguồn agent: `29-Cong-Cu/plugin_src/agents/`. Cowork chạy agent: chưa kiểm chứng — `DL-20260919-004` |
