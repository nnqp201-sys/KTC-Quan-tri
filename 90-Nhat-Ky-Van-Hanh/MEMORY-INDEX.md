...
| Gói `ktc-bao-cao` | **`ktc-bao-cao-v3.13.skill`** (19/9/2026) — quy tắc viện dẫn (`DL-20260919-002`), đơn vị nộp qua khung chat (`DL-20260919-001`), Task_ID (`DL-20260918-003`). Gói cũ giữ để hoàn tác, **không dùng** |
...
| Cấu trúc thư mục | Nhóm theo số (`DL-20260918-004`): 1x INPUT · 2x PROCESS · 3x OUTPUT · 9x quản trị. Gói: quan-tri 1.7, ke-hoach 3.8, theo-doi-cv 1.6, soan-thao-vb 1.7 |
