...
| Gói `ktc-bao-cao` | **`ktc-bao-cao-v3.12.skill`** (18/9/2026) — Task_ID (`DL-20260918-003`), kết cấu thư mục (`-004`), Nguyên tắc 4 (`-005`). Gói cũ giữ để hoàn tác, **không dùng** |
...
| Cấu trúc thư mục | Nhóm theo số (`DL-20260918-004`): 1x INPUT · 2x PROCESS · 3x OUTPUT · 9x quản trị. Gói: quan-tri 1.6, ke-hoach 3.7, theo-doi-cv 1.5, soan-thao-vb 1.6 |
