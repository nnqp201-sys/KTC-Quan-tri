# 11-Du-Lieu-Dau-Vao — Kho dữ liệu đầu vào dùng chung của KTC-Quan-tri

**Lập ngày:** 14/9/2026 · **Thay thế:** `KTC-Ke-Hoach/Nhap_Ke_Hoach/input-KH_*`
...
| Vấn đề | Bằng chứng |
|---|---|
| Cùng một tệp phục vụ nhiều hệ nhưng chỉ nằm ở một nhánh | 12 tệp kế hoạch tháng 9/2026 nằm trong `KTC-Bao-Cao/Nhap_Bao_Cao/`, vì đơn vị nộp gộp báo cáo tháng 8 và kế hoạch tháng 9 cùng một lần |
...
4. **Tên thư mục đầu mối dùng mã chuẩn** theo `01-Chuan-Chung/13-Bang-Ma-Don-Vi.md` — không ghi tên tự do.
...
> `KTC-Ke-Hoach/references/Skill-Library/36-Skill-Tong-Hop-Ke-Hoach-Truong.md`, bảng "Bốn nguồn".
...
`11-Du-Lieu-Dau-Vao` là **kho đang xử lý** — hồ sơ nhận vào, chưa qua tổng hợp.
...
| Nguồn cũ | Trạng thái |
|---|---|
| `KTC-Ke-Hoach/Nhap_Ke_Hoach/input-KH_Nam/KH Truong/` (2 tệp) | ✅ đã chuyển sang `02-Cap-Truong/2026/` |
| `KTC-Ke-Hoach/Nhap_Ke_Hoach/input-KH_Quy/KH-Truong/` (1 tệp) | ✅ đã chuyển sang `02-Cap-Truong/2026-Q3/` |
| `KTC-Bao-Cao/Nhap_Bao_Cao/input-BC-Thang/` (40 tệp thật) | ✅ **đã chuyển** 14/9/2026 — bảng ánh xạ đầy đủ tại `12-Output/2026-09-14/Anh-xa-chuyen-Nhap_Bao_Cao.md` |
| 60 thư mục rỗng còn lại của hai nhánh cũ | ⏸ chờ người dùng xóa thủ công — `12-Output/2026-09-14/Danh-muc-can-don-toan-he.md` |

**Kho này nay là nguồn đầu vào DUY NHẤT.** Hai công cụ `tools/build_xl.py` và
`tools/trich_tuong_thuat.py` đã trỏ sang đây và chạy đúng trên dữ liệu thật (13 đơn vị, 198 ý kết quả,
130 ý kế hoạch).
