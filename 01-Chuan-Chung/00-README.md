# 01-Chuan-Chung — Lớp chuẩn dùng chung của KTC-Quan-tri
...
```
01-Chuan-Chung/<tệp>.md          ← sửa ở đây (nguồn gốc)
        ↓ nhân bản tại bước đóng gói
KTC-Ke-Hoach/references/Skill-Library/<tệp>.md
KTC-Bao-Cao/references/Skill-Library/<tệp>.md
...
| `15-Skill-Track-Changes.md` | Điều kiện kích hoạt + quy trình 4 bước dùng `tools/ktc_trackchanges.py`; thi hành NT-2 | **Đã kiểm thử** |
