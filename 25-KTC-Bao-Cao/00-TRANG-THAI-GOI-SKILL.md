...
**v3.6 (14/9/2026)** = v3.5 + đưa **3 tệp dùng chung** về đúng bản gốc ở `20-Chuan-Chung/`:
...
không ghi đè. Dùng `29-Cong-Cu/dong_goi_skill.py` — có sẵn hàm kiểm frontmatter, kiểm liên kết gãy và đối chiếu
