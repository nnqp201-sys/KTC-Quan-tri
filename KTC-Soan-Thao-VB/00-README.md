...
tự chứa. Bản gốc ở `KTC-Quan-tri/01-Chuan-Chung/`, nhân bản lại tại bước đóng gói.
...
Đặc tả đầy đủ ở `KTC-Quan-tri/01-Chuan-Chung/14-Nguyen-Tac-Soan-Thao-Bat-Bien.md`:
...
- **Hệ cũ `KTC-DIS-Tong-Hop-VB/` vẫn còn nguyên** — theo quy ước của dự án, tệp trên Drive chỉ do người
  dùng xóa thủ công. Danh sách tệp cần dọn: `12-Output/2026-09-14/Danh-muc-can-don-KTC-DIS-Tong-Hop-VB.md`.
