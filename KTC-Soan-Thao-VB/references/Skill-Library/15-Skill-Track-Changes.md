...
**Ban hành:** 13/9/2026 · **Thi hành cho:** `01-Chuan-Chung/14-Nguyen-Tac-Soan-Thao-Bat-Bien.md` NT-2
**Mô-đun:** `tools/ktc_trackchanges.py` · **Kiểm thử:** `99-Kinh-Nghiem/02-Regression/Cases/test_trackchanges.py`
...
- `99-Kinh-Nghiem/05-Known-Issues/Pending.md` — `KI-009` (đã đóng bằng mô-đun này)
