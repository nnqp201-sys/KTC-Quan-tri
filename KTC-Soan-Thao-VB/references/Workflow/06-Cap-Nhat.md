...
| Quy tắc dùng chung cho nhiều hệ | **`01-Chuan-Chung/` của KTC-Quan-tri** — không sửa riêng ở hệ này |
...
tự chứa. Với chúng, bản gốc ở `01-Chuan-Chung/` và nhân bản lại **tại bước đóng gói**.
