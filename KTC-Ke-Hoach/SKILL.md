...
2. **Bắt buộc xuất kết quả cuối thành file .docx** lưu vào `12-Output/YYYY-MM-DD/<loại thao tác>/`
   — nơi xuất DUY NHẤT của toàn dự án (`01-Chuan-Chung/00-Nguyen-Tac-Chung.md`). Thư mục riêng
...
| 1 | — | Thu thập đề xuất theo kỳ vào `11-Du-Lieu-Dau-Vao/01-Dau-Moi-Nop/<kỳ>/` |
...
| 6 | — | Xuất .docx → lưu `12-Output/YYYY-MM-DD/<loại thao tác>/` |
...
## Dữ liệu đầu vào — kho dùng chung `11-Du-Lieu-Dau-Vao/`

> **[SỬA 14/9/2026]** Thư mục riêng `Nhap_Ke_Hoach/input-KH_*` **đã bỏ**. Đầu vào của mọi hệ nay nằm chung
> ở `11-Du-Lieu-Dau-Vao/` cấp dự án. Đọc `11-Du-Lieu-Dau-Vao/00-README.md` trước khi chạy Bước 0.
...
(`01-Chuan-Chung/13-Bang-Ma-Don-Vi.md`).
...
`12-Output/YYYY-MM-DD/` là **căn cứ chính thức** cho `ktc-bao-cao` đối chiếu tiến độ báo cáo — 2 hệ khép vòng Kế hoạch ↔ Báo cáo.
