...
- Khi đầu mối nộp hồ sơ vào `11-Du-Lieu-Dau-Vao/01-Dau-Moi-Nop/<kỳ>/`.
...
> dữ liệu đầu vào nay nằm ở kho dùng chung cấp dự án `11-Du-Lieu-Dau-Vao/` — đọc
> `11-Du-Lieu-Dau-Vao/00-README.md` trước khi chạy Pre-flight.
>
...
Bảng ánh xạ tên đầy đủ và các biến thể đang tồn tại: `01-Chuan-Chung/13-Bang-Ma-Don-Vi.md`.
...
- Vị trí: `11-Du-Lieu-Dau-Vao/01-Dau-Moi-Nop/<kỳ>/<mã đầu mối>/`
...
- Vị trí: `11-Du-Lieu-Dau-Vao/02-Cap-Truong/<kỳ>/` (cấp Trường) hoặc `11-Du-Lieu-Dau-Vao/04-Van-Ban-Cap-Tren/<năm>/` (cấp trên Trường)
...
- Vị trí: `11-Du-Lieu-Dau-Vao/04-Van-Ban-Cap-Tren/<năm>/` — cùng vị trí Luồng B
...
Kiểm tra `11-Du-Lieu-Dau-Vao/02-Cap-Truong/<kỳ>/` và `04-Van-Ban-Cap-Tren/<năm>/` có ≥1 file Luồng B/C đúng phạm vi:
