...
| `01-Master-Task-Register` | 46 cột theo `01-Chuan-Chung/10-Tu-Dien-Truong-Du-Lieu.md`. Hàng 2 ghi nhóm A–H, hàng 3 đánh dấu trường bắt buộc |
...
2. **Chốt quy tắc Task_ID** — xem `01-Chuan-Chung/11-Quy-Tac-Task-ID.md`.
...
`01-Chuan-Chung/13-Bang-Ma-Don-Vi.md`). Khi một Khoa đăng ký nhiệm vụ không khớp mã nào, để trống
