...
độc lập khi lập lớp `20-Chuan-Chung/`.
...
2. Bổ sung vào `29-Cong-Cu/dong_goi_skill.py` một bước **bắt buộc chặn**: so danh sách tệp và kích thước giữa
   nguồn rời và gói hiện hành; phát hiện tệp thiếu hoặc tệp trong gói lớn hơn → **dừng, không đóng gói**.
3. Ca hồi quy đi kèm: `92-Kinh-Nghiem/02-Regression/Cases/test_dong_goi_khong_thoai_lui.py`.
...
> được** — không ép dữ liệu cho khớp. Xem `KI-004` (đã đóng) và `20-Chuan-Chung/13-Bang-Ma-Don-Vi.md`.
...
Đếm thư mục nộp thật tại `25-KTC-Bao-Cao/Nhap_Bao_Cao/input-BC-Thang/`: 5 Phòng + 6 Khoa (khớp đúng 11 mã của
...
**Đề nghị làm:** bổ sung vào `20-Chuan-Chung/13-Bang-Ma-Don-Vi.md` một mục *"Đầu mối nộp báo cáo"* tách khỏi
...
**Đề nghị làm:** lập `90-Nhat-Ky-Van-Hanh/04-Chat-Luong-Du-Lieu-Don-Vi.md` với bảng 13 đầu mối × các kỳ, nạp
...
**Đề nghị làm:** `92-Kinh-Nghiem/05-Known-Issues/BUG-Registry-Scripts.md` — nhập 16 mã BUG cũ kèm cột "bản
nào đã vá", mở rộng cho các script hiện có của dự án (`29-Cong-Cu/` 11 tệp + `Skill-Library/` 6 tệp), giữ nguyên
...
**Đề nghị làm:** `29-Cong-Cu/xuat_goi_ban_giao.py` — nhận tên một hệ con, sinh gói 8 phần vào
`30-Ket-Qua/YYYY-MM-DD/Ban-giao/`. Ưu tiên thấp: chỉ làm sau khi ĐX-1 xong, vì xuất gói từ nguồn đang lệch
...
`25-KTC-Bao-Cao/00-TRANG-THAI-GOI-SKILL.md`
