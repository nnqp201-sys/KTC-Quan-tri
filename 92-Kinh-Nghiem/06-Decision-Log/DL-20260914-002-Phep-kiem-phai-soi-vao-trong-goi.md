...
Phép kiểm **C5** của `29-Cong-Cu/kiem_tra_he_thong.py` so bản gốc `20-Chuan-Chung/` với bản sao ở
...
`29-Cong-Cu/dong_goi_skill.py` không gom thư mục nguồn rời rồi nén. Nó chạy:
...
- Ca thử ngược bắt buộc: `92-Kinh-Nghiem/02-Regression/Cases/test_c5_soi_trong_goi.py` — 5 ca, gồm ca
