...
Đầu vào trước đây tách theo **hệ tiêu thụ**: `23-KTC-Ke-Hoach/Nhap_Ke_Hoach/input-KH_<kỳ>/` và
`25-KTC-Bao-Cao/Nhap_Bao_Cao/input-BC-Thang/`. Thiết kế này đúng khi dự án chỉ có hai hệ. Nay đã mở rộng
...
Lập **`10-Dau-Vao/`** cấp dự án, tổ chức theo **nguồn gốc dữ liệu**, không theo hệ tiêu thụ:
...
- 28 thư mục rỗng để người dùng tự xóa — danh sách tại
  `30-Ket-Qua/2026-09-14/Danh-muc-can-don-thu-muc-input-KH.md`.

## Việc CHƯA làm — nói rõ để không tưởng đã xong

`25-KTC-Bao-Cao/Nhap_Bao_Cao/input-BC-Thang/` còn **khoảng 40 tệp dữ liệu thật** của kỳ tháng 8–9/2026,
**chưa chuyển**. Ba lý do: đây là dữ liệu vận hành đang dùng; hai công cụ `29-Cong-Cu/trich_tuong_thuat.py` và
`29-Cong-Cu/build_xl.py` ghi cứng đường dẫn cũ; và cần quy ước đặt tên để phân biệt tệp kế hoạch với tệp báo
...
`36-Skill-Tong-Hop-Ke-Hoach-Truong.md` (bảng Bốn nguồn) · `10-Dau-Vao/00-README.md`
