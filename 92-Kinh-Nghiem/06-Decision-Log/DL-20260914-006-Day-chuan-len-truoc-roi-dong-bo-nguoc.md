...
Soi vào trong 6 tệp `.skill`: 5 hệ khớp `20-Chuan-Chung/`, riêng `ktc-ra-soat-897` lệch 4 tệp dùng chung.
...
| Đẩy lên `20-Chuan-Chung` | Bài học connector 08/9 · `phapluat.gov.vn` là nguồn Mức 1 ưu tiên cao nhất · bản VBHN đầy đủ hơn · câu quy tắc kho viết lại cho trung tính |
