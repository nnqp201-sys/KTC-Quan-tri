...
| Phạm vi log | Chỉ khi thư mục có `90-Nhat-Ky-Van-Hanh/` | Plugin bật ở cấp người dùng — không được ghi log vào dự án khác |
...
| Nguồn script | `29-Cong-Cu/plugin_src/` — build chép vào `31-Plugin/` | Giữ đúng nguyên tắc "không sửa tay trong gói đã build" |

## Kiểm chứng

`92-Kinh-Nghiem/02-Regression/Cases/test_plugin_nhat_ky_backup.py` — 10/10 ca đạt, gồm 4 ca ngược (ngoài dự án
...
1. **URL repo GitHub PRIVATE.** Repo sẽ chứa hồ sơ đơn vị nộp (`10-Dau-Vao/`), bản dự thảo văn bản,
