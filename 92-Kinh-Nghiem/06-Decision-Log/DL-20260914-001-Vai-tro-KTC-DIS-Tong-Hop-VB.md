...
**Kết quả:** hệ mới `26-KTC-Soan-Thao-VB/` — **90 tệp** (hệ cũ 122), gói `ktc-soan-thao-vb.skill` 120 KB,
...
`30-Ket-Qua/2026-09-14/Danh-muc-can-don-KTC-DIS-Tong-Hop-VB.md`.
...
`20-Chuan-Chung/`, hiện đang lệch khoảng một tháng.
...
từng hệ vì `.skill` là zip tự chứa. Với những tệp đó, bản gốc ở `20-Chuan-Chung/` và phải nhân bản lại **tại
