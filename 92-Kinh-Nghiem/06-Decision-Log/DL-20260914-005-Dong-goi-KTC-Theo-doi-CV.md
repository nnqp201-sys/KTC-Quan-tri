...
| Nguồn | Dùng để |
|---|---|
| `20-Chuan-Chung/12-Vong-Doi-Trang-Thai.md` | 7 trạng thái chính, 5 trạng thái phụ, 8 cảnh báo |
| `20-Chuan-Chung/11-Quy-Tac-Task-ID.md` | Quy tắc cấp và dùng Task_ID |
| 19+11+10+14 cột của `01. Bộ dữ liệu vận hành` | Trường bắt buộc của từng skill |
| `24-KTC-Theo-doi-CV/00-README.md` | Vai trò, quyền ghi nhóm F/G, chốt chặn 897 |
...
**Liên quan:** `DL-20260914-004` · `24-KTC-Theo-doi-CV/00-README.md` · `20-Chuan-Chung/12-Vong-Doi-Trang-Thai.md`
