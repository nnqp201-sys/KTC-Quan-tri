...
1. **Chỉ nhận nguồn Mức 1 hoặc Mức 2** (theo phân loại tại `00-Quy-Tac-Khai-Thac-Internet.md`):
   - Mức 1: Công báo Chính phủ, vbpl.vn, Cổng TTĐT Chính phủ/Bộ/tỉnh, website chính thức của Trường.
...
- `03-Quy-Trinh-Nap-Lieu-2-Tang.md` (quy trình nạp chung — bước xác nhận với người dùng áp dụng thêm cho trường hợp này)
