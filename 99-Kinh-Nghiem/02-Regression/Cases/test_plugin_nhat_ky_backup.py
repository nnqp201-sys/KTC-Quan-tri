...
NK = os.path.join(GOC, "tools", "plugin_src", "scripts", "ktc_nhat_ky.py")
BK = os.path.join(GOC, "tools", "plugin_src", "scripts", "ktc_backup_github.py")
loi = []
...
with tempfile.TemporaryDirectory() as t:
    ...
    log_dir = os.path.join(du_an, "03-Nhat-Ky-Van-Hanh", "04-Nhat-Ky-Tu-Dong")
    ...
    git("init", "-q", repo); os.makedirs(os.path.join(repo, "03-Nhat-Ky-Van-Hanh"))
