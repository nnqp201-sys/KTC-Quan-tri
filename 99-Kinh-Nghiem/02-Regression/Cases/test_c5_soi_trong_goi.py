...
Ly do ton tai: 14/9/2026 phat hien C5 ban dau chi so 01-Chuan-Chung voi BAN ROI
...
Chay: python 99-Kinh-Nghiem/02-Regression/Cases/test_c5_soi_trong_goi.py
"""
import io
import os
import shutil
...
def dung_du_an(noi_dung_roi, noi_dung_goi):
    ...
    ghi(os.path.join(tmp, "01-Chuan-Chung", TEP), GOC)
