...
LIB = os.path.join(GOC, "KTC-Bao-Cao", "references", "Skill-Library")
...
# ban cu v3.2 tu git de so sanh hanh vi
cu_src = subprocess.run(["git", "-C", GOC, "show", "HEAD:KTC-Bao-Cao/references/Skill-Library/read_bc736_excel.py"],
...
with tempfile.TemporaryDirectory() as t:
    ...
    tep = sorted(glob.glob(os.path.join(GOC, "11-Du-Lieu-Dau-Vao", "01-Dau-Moi-Nop", "2026-09", "*", "*.xlsx")))
