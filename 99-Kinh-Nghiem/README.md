# 99-Kinh-Nghiem — Lớp tiến hóa tri thức của KTC-Quan-tri

**Ngày lập:** 13/9/2026 · **Mô hình kế thừa:** `KTC-Ra-Soat-897-v2-Cai-tien/99-Kinh-Nghiem/` (lập 30/8/2026)
...
|---|---|
| Quy tắc, bảng mã, từ điển dữ liệu dùng chung | `01-Chuan-Chung/` |
| Sổ dữ liệu nhiệm vụ | `02-Master-Task-Register/` |
| Bộ nhớ vận hành từng ca | `03-Nhat-Ky-Van-Hanh/` |
| Tài liệu kiến trúc | `04-Tai-Lieu-Thiet-Ke/` |
...
03-Change-Proposals/    kèm ca kiểm thử tại 02-Regression/Cases/
        ...
        │            │
        │            ▼  áp dụng vào 01-Chuan-Chung/ và gói skill
        │            ▼  04-Release-Notes/
        │
...
## 4. Quan hệ với `03-Nhat-Ky-Van-Hanh/`

Hai lớp khác nhau, đừng trộn:

| | `03-Nhat-Ky-Van-Hanh/` | `99-Kinh-Nghiem/` |
|---|---|---|
