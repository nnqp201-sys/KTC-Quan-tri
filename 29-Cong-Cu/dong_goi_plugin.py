...
GOI_NGUON = [
    ...
    (os.path.join(DU_AN, "24-KTC-Theo-doi-CV", "ktc-theo-doi-cv-v1.2.skill"), "ktc-theo-doi-cv", "theo-doi-cv"),
]

PLUGIN_VERSION = "0.4.0"  # 0.2.0: them agent tu cai tien, tu ghi nhat ky, tu backup GitHub
...
def build_manifest():
    ...
    manifest = {
        ...
        "metadata": {
            ...
            "parallelWith": ["ktc-quan-tri.skill", "ktc-bao-cao-v3.9.skill", "ktc-ke-hoach-v3.4.skill",
                              "ktc-soan-thao-vb-v1.3.skill", "ktc-theo-doi-cv-v1.2.skill"],
        },
    }
