...
GOI_NGUON = [
    ...
    (os.path.join(DU_AN, "26-KTC-Soan-Thao-VB", "ktc-soan-thao-vb-v1.7.skill"), "ktc-soan-thao-vb", "soan-thao-vb"),
    (os.path.join(DU_AN, "24-KTC-Theo-doi-CV", "ktc-theo-doi-cv-v1.6.skill"), "ktc-theo-doi-cv", "theo-doi-cv"),
]

PLUGIN_VERSION = "0.5.3"  # 0.2.0: them agent tu cai tien, tu ghi nhat ky, tu backup GitHub
    ...
    manifest = {
        ...
        "metadata": {
            ...
            "parallelWith": ["ktc-quan-tri.skill", "ktc-bao-cao-v3.13.skill", "ktc-ke-hoach-v3.8.skill",
                              "ktc-soan-thao-vb-v1.7.skill", "ktc-theo-doi-cv-v1.6.skill"],
        },
    }
