...
GOI_NGUON = [
    ...
    (os.path.join(DU_AN, "25-KTC-Bao-Cao", "ktc-bao-cao-v3.10.skill"), "ktc-bao-cao", "bao-cao"),
    (os.path.join(DU_AN, "23-KTC-Ke-Hoach", "ktc-ke-hoach-v3.5.skill"), "ktc-ke-hoach", "ke-hoach"),
    (os.path.join(DU_AN, "26-KTC-Soan-Thao-VB", "ktc-soan-thao-vb-v1.4.skill"), "ktc-soan-thao-vb", "soan-thao-vb"),
    (os.path.join(DU_AN, "24-KTC-Theo-doi-CV", "ktc-theo-doi-cv-v1.3.skill"), "ktc-theo-doi-cv", "theo-doi-cv"),
]

PLUGIN_VERSION = "0.5.0"  # 0.2.0: them agent tu cai tien, tu ghi nhat ky, tu backup GitHub
...
def build_manifest():
    ...
    manifest = {
        ...
        "metadata": {
            ...
            "parallelWith": ["ktc-quan-tri.skill", "ktc-bao-cao-v3.10.skill", "ktc-ke-hoach-v3.5.skill",
                              "ktc-soan-thao-vb-v1.4.skill", "ktc-theo-doi-cv-v1.3.skill"],
        },
    }
