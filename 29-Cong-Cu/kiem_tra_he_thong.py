...
HE = {
    ...
    "ktc-kpi-lap-ke-hoach": ("28-KTC-KPI", "28-KTC-KPI/ktc-kpi-lap-ke-hoach-v1.2.skill"),
    "ktc-kpi-tu-danh-gia": ("28-KTC-KPI/Tu-Danh-Gia", "28-KTC-KPI/Tu-Danh-Gia/ktc-kpi-tu-danh-gia-v1.1.skill"),
}
...
def c9_cong_cu():
    ...
    for mod, ham in [("ktc_trackchanges", "kiem_tra"), ("vanphong", "cap_truong"),
                     ...
                     ("doi_soat_so_lieu", "doi_soat"), ("kiem_minh_chung", "kiem")]:
        try:
            m = __import__(mod)
