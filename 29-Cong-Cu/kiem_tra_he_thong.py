...
Chay: python 29-Cong-Cu/kiem_tra_he_thong.py
      python 29-Cong-Cu/kiem_tra_he_thong.py --chi-tiet
...
HE = {
    "ktc-bao-cao":      ("25-KTC-Bao-Cao", "25-KTC-Bao-Cao/ktc-bao-cao-v3.12.skill"),
    "ktc-ke-hoach":     ("23-KTC-Ke-Hoach", "23-KTC-Ke-Hoach/ktc-ke-hoach-v3.7.skill"),
    "ktc-soan-thao-vb": ("26-KTC-Soan-Thao-VB", "26-KTC-Soan-Thao-VB/ktc-soan-thao-vb-v1.6.skill"),
    "ktc-theo-doi-cv":  ("24-KTC-Theo-doi-CV", "24-KTC-Theo-doi-CV/ktc-theo-doi-cv-v1.5.skill"),
...
def c5_tep_dung_chung():
    ...
    """
    tieu_de("C5. 5 tệp dùng chung — khớp bản gốc 20-Chuan-Chung "
            "(soi cả bản rời lẫn bản TRONG GÓI)")
    goi_ct = {ten: _noi_dung_goi(goi) for ten, (_, goi) in HE.items()}
    for f in CHUNG:
        goc = os.path.join(DU_AN, "20-Chuan-Chung", f)
        if not os.path.exists(goc):
            loi.append(f"C5: thiếu bản gốc 20-Chuan-Chung/{f}")
...
def c10_regression():
    ...
    d = os.path.join(DU_AN, "92-Kinh-Nghiem", "02-Regression", "Cases")
