...
Đầu vào lấy từ kho dùng chung `11-Du-Lieu-Dau-Vao/` — xem `00-README.md` của kho đó.
...
Định nghĩa đầy đủ 12 trạng thái và điều kiện chuyển: `01-Chuan-Chung/12-Vong-Doi-Trang-Thai.md` —
