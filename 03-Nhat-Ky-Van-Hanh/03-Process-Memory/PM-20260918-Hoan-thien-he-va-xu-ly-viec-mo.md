...
control_versions:
  ...
  bang_ma_don_vi: 01-Chuan-Chung/13-Bang-Ma-Don-Vi.md (13/9/2026) — phát hiện lệch với Checklist 08 của 897
...
sources_verified:
  ...
  - source: KTC-Ra-Soat-897 Checklist 08 (core/references/Checklist/08-Quy-Uoc-Rieng-CDKT.md)
    ...
    note: phê duyệt 18/8/2026 bởi Phó Trưởng phòng TH-HC&QT — nguồn thể thức có thẩm quyền cao hơn
      01-Chuan-Chung/13 cho việc soạn văn bản

process_steps:
  - step: 1. Khởi động — đọc MEMORY-INDEX + Pending.md, chạy kiem_tra_he_thong.py
    action: chạy python tools/kiem_tra_he_thong.py --chi-tiet
    result: 12 lỗi C5 ban đầu — tất cả cùng gốc, gói .skill cũ chưa đồng bộ 01-Chuan-Chung
...
key_findings:
  ...
  - id: F2
    ...
    status: open
  - id: F3
    location: 01-Chuan-Chung/13-Bang-Ma-Don-Vi.md dòng 17 vs Checklist 08 mục 3.4 (897)
    ...
    status: open   # chưa sửa 01-Chuan-Chung/13 — ngoài phạm vi ca này, chỉ ghi nhận
  - id: F4
...
decisions:
  - decision: Trỏ tools/kiem_tra_he_thong.py vào 4 gói .skill mới thay vì đóng gói lại từ đầu
    reason: đã xác minh byte-for-byte gói mới khớp nguồn rời và 01-Chuan-Chung, không mất nội dung so
      với gói cũ
    made_by: AI
...
outputs:
  - name: 99-Kinh-Nghiem/06-Decision-Log/DL-20260918-001-Hoan-tat-dot-dong-goi-15-9-con-do-dang.md
    status: hoàn chỉnh
  - name: 12-Output/2026-09-18/De-xuat/De-xuat-Bo-sung-Cot-Task_ID-Phu-luc-TB736.md
    status: hoàn chỉnh, chờ người có thẩm quyền xác nhận trước khi áp dụng
  - name: 12-Output/2026-09-18/Cong-Van/DU-THAO_CV_Bo-sung-chinh-sua-ho-so-KH-BC-thang-8-9-2026.docx
