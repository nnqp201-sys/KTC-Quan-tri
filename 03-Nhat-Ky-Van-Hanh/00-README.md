# 03-Nhat-Ky-Van-Hanh — Bộ nhớ quá trình cấp dự án

Lớp này lưu **quá trình**: đã làm gì, vì sao quyết định như vậy, gặp vấn đề gì, rút ra bài học nào. Khác với
`01-Chuan-Chung/` (lưu *cách làm* — quy tắc tĩnh) và `02-Master-Task-Register/` (lưu *dữ liệu*).
...
Gói `KTC-Bao-Cao/ktc-bao-cao-v2_5_1-memory.skill` đã hiện thực hóa đúng thứ này ở cấp một hệ, gồm 6 tệp và
...
| Nơi | Dạng | Phạm vi |
|---|---|---|
| `KTC-Bao-Cao/memory/` | 6 tệp `.md` | Riêng hệ báo cáo — mô hình chín nhất |
| `KTC-Ke-Hoach/00-Nhat-Ky-Van-Hanh.xlsx` | Excel | Riêng hệ kế hoạch |
| `KTC-Theo-doi-CV/02. Nhật ký liên thông KTC-Theo-dõi-CV.xlsx` | Excel | Riêng hệ theo dõi |
