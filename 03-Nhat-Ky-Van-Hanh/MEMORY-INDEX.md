...
| Plugin `ktc-quan-tri` | **0.2.0** (18/9/2026) — 5 skill + agent `ktc-tu-cai-tien` (chỉ đề xuất) + hook tự ghi nhật ký `04-Nhat-Ky-Tu-Dong/` và nạp vào context + backup GitHub 21:00 (Task Scheduler `KTC-Quan-tri-Backup-GitHub`). **Chưa nối remote GitHub** — `DL-20260918-002`. Build: `tools/dong_goi_plugin.py` |
